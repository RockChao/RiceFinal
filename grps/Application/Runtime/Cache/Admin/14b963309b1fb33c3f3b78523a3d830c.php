			        	...
			        	<td><?php echo $value['user_region']?></td>
			         	...
			         	<td>
			         		...
			         		<div id="b">
								...
								<a href= "/grps/index.php/admin/user/../User/deleteUser?user_id=<?php  echo $value['user_id'];?>" class="btn btn-warning del" role="button">删除</a>
								<?php }else{ ?>
								<a class="btn" disabled="disabled">删除</a>
								<?php } ?>
								<a href="/grps/index.php/admin/user/../User/updateInfo?user_id=<?php  echo $value['user_id']; ?>" class="btn btn-primary" role="button">编辑</a>
							</div>

							<!--
							<div id="s" style="display:none">
								<p>是否要删除<?php echo $value['user_name']?>的相关信息？</p>
								<a href= "/grps/index.php/admin/user/../User/deleteUser?user_id=<?php  echo $value['user_id'];?>" class="btn btn-warning">删除</a>
