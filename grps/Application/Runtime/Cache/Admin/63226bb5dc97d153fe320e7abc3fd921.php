<?php if (!defined('THINK_PATH')) exit();?><html>
	...
	<body>
		...
		<div class="add1">
			<form  action="<?php echo U('Disaster/checkDisaster'); ?>" method = "post" class="form-horizontal" role="form">
				...
				<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="disa_date" value="<?php echo $disasterdata['disa_begindate'];?>" readonly>
			      	</div>
			   	</div>
			   	...
			   	<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="disa_date" value="<?php echo $disasterdata['disa_enddate'];?>" readonly>
			      	</div>
			   	</div>
			  	...
			  	<div class="form-group">
			   	...
			   	<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="disa_eloss" value="<?php echo $disasterdata['disa_eloss'];?>" readonly>
			      	</div>
			   	</div>
			   	<div class="form-group">
			      	<label class="col-sm-2 control-label">灾情描述：</label>
			      	<div class="col-sm-3">
			         	<textarea class="form-control" name="disa_description" rows="8" cols="39" readonly><?php echo $disasterdata['disa_description'];?></textarea>
			      	</div>
			   	</div>
			   	<input type="hidden" name="disa_id" value="<?php echo $disasterdata['disa_id'];?>">
			    <div class="form-group">
			      	<div class="col-sm-offset-2 col-sm-10">
			         	<input type="submit" class="btn btn-info" value="通过">
			          <input type="submit" name="failed" id="failed" class="btn btn-warning" value="驳回">
			     	</div>	
			   	</div>
