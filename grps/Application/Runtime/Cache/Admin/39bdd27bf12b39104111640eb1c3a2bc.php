...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<form name="form1" method="post" action="<?php echo U('Rice/exportDataToExcel'); ?>">
				<table class="bordered-table zebra-striped" id="example">
				   ...
				   <tbody>
				      	<?php foreach ($ricedata as $key => $value): ?>
				   			<tr>
				   				<td>
				   					<input type="checkbox" name="rice_ids[]" value="<?php echo $value['rice_id']?>">
				   				</td>
					        	<td><?php echo $value['dist_name']?></td>
					         	...
					         	<td>
					         		<a href="/grps/index.php/Admin/Rice/../Rice/detailRice?rice_id=<?php  echo $value['rice_id']; ?>" class="btn btn-info" role="button">详情</a>
					         		<a href="/grps/index.php/Admin/Rice/../Rice/deleteRice?rice_id=<?php  echo $value['rice_id']; ?>" class="btn btn-danger" onclick="javascript:if(confirm('确定要删除此信息吗？')){return true;}return false;">删除</a>
