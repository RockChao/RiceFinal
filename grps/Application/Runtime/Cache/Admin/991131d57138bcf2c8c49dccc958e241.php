    ...
    <div class='container'>
        ...
        <div class='tab-content'>
            ...
            <?php if($ricedata['brice_status']==1){?>
			    ...
			    <?php } else if($ricedata['brice_status']==2||$ricedata['brice_status']==4){?>
			    <form action="" method = "post" class="form-horizontal" role="form">
			  	<div class="form-group">
			      	<label for="username" class="col-sm-3 control-label">区县：</label>
			      	<div class="col-sm-3">
			    ...
			    <div class="form-group">
			      	...
			      	<?php if($ricedata['brice_status']==2) { ?>
			        	<input class="btn btn-warning" disabled="disabled" value="信息尚未审核">
			        <?php } else { ?>
			        	<input class="btn btn-warning" disabled="disabled" value="信息审核未通过">
			        <?php } ?>
			     	</div>
			   	</div>
			   	</form>
			   	...
			   	<?php } else{ ?>
			   	<form action="<?php echo U('Admin/Rice/updateRice'); ?>" id="briceform" method = "post" class="form-horizontal" role="form">
			  	<div class="form-group">
			      	<label for="username" class="col-sm-3 control-label"><span class="need">*</span>区县：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="rice_region" value="<?php echo $ricedata['rice_region'];?>" readonly>
			      	</div>
			   	</div>
			  	<div class="form-group">
			   	...
			   	<div class="form-group">
			      	<label for="password" class="col-sm-3 control-label"><span class="need">*</span>总人口(人)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="population" value="<?php echo $ricedata['population'];?>" id="population">
			      	</div>
			   	...
			   	<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="agri_population"  value="<?php echo $ricedata['agri_population'];?>" id="agri_population">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			   	</div>
			   	<div class="form-group">
			      	<label for="zone_area" class="col-sm-3 control-label"> <span class="need">*</span>地区总面积(亩)： </label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="zone_area"  value="<?php echo $ricedata['zone_area'];?>" id="zone_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			   	</div>
			   	<div class="form-group">
			      	<label for="agri_area" class="col-sm-3 control-label"><span class="need">*</span>耕地面积(亩)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="agri_area"  value="<?php echo $ricedata['agri_area'];?>" id="agri_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			   	</div>
			   	<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="field_area"  value="<?php echo $ricedata['field_area'];?>" id="field_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="total_sown_area"  value="<?php echo $ricedata['total_sown_area'];?>" id="total_sown_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>

			    <input type="hidden" class="form-control" name="rice_kind"  value=1>

			    <div class="form-group">
			      	<label for="reason" class="col-sm-3 control-label"><span class="need">*</span>修改理由：</label>
			      	<div class="col-sm-3">
			         	<textarea name="reason" rows="5" cols="27" id="reason"></textarea>
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    ...
			    <div class="form-group">
			      	<div class="col-sm-offset-3 col-sm-10">
			        	...
			        	<a href="<?php echo U('Rice/manageRice'); ?>"<button  class="btn btn-success">返回</button> </a>
			     	</div>
			   	</div>
			   	</form>
			    <?php } ?>
            ...
            <?php if($ricedata['erice_status']==1){?>
			    ...
			    <input type="hidden" class="form-control" name="rice_kind"  value=2>
			    <div class="form-group">
			      	<div class="col-sm-offset-3 col-sm-10">
			      	<input class="btn btn-warning" disabled="disabled" value="信息尚未提交">
			     	</div>
			...
			<?php } else if($ricedata['erice_status']==2||$ricedata['erice_status']==4){?>
				<form action="" method = "post" class="form-horizontal" role="form">
			...
			<?php }else{ ?>
			    <form action="<?php echo U('Admin/Rice/updateRice'); ?>" id="ericeform" method="post" class="form-horizontal" role="form">
            	<div class="form-group">
			      	<label for="year" class="col-sm-3 control-label"><span class="need">*</span>年份(年)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="year"  value="<?php echo $ricedata['year'];?>" readonly>
            	...
            	<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="e_sown_area"  value="<?php echo $ricedata['e_sown_area'];?>" id="e_sown_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    
			    <div class="form-group">
			      	<label for="e_disaster_area" class="col-sm-3 control-label"><span class="need">*</span>早稻受灾面积(亩)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="e_disaster_area"  value="<?php echo $ricedata['e_disaster_area'];?>" id="e_disaster_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="e_production"  value="<?php echo $ricedata['e_production'];?>" id="e_production" >
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			     <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="e_market_price"  value="<?php echo $ricedata['e_market_price'];?>" id="e_market_price">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="e_purchase_price"  value="<?php echo $ricedata['e_purchase_price'];?>" id="e_purchase_price">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	<label for="e_fertilizer_price" class="col-sm-3 control-label"><span class="need">*</span>早稻肥料价格(元/公斤)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="e_fertilizer_price"  value="<?php echo $ricedata['e_fertilizer_price'];?>" id="e_fertilizer_price" >
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			    ...
			    <input type="hidden" name="rice_kind"  value=2>
			  	<input type="hidden" name="rice_id" value="<?php echo $ricedata['rice_id']; ?>">
			    <div class="form-group">
			      	<div class="col-sm-offset-3 col-sm-10">
			        	<input type="submit" class="btn btn-info" value="确认修改">
            ...
            <?php if($ricedata['lrice_status']==1){ ?>
			    ...
			    <div class="form-group">
			      	<label for="l_fertilizer_price" class="col-sm-3 control-label">晚稻肥料价格(元/公斤)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_fertilizer_price"  value="-" readonly>
			      	</div>
			    </div>
			     <input type="hidden" class="form-control" name="rice_kind"  value=3>
			    <div class="form-group">
			      	<div class="col-sm-offset-3 col-sm-10">
			        	<input class="btn btn-warning" disabled="disabled" value="信息尚未提交">
			     	</div>
			...
			<?php } else if($ricedata['lrice_status']==2||$ricedata['lrice_status']==4){ ?>
				<form action="" method = "post" class="form-horizontal" role="form">
            	<div class="form-group">
			      	<label for="year" class="col-sm-3 control-label">年份(年)：</label>
			      	<div class="col-sm-3">
			...
			<?php } else{ ?>
			    <form action="<?php echo U('Admin/Rice/updateRice'); ?>" id="lriceform" method = "post" class="form-horizontal" role="form">
            	...
            	<div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_sown_area"  value="<?php echo $ricedata['l_sown_area'];?>" id="l_sown_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    ...
			    <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_disaster_area"  value="<?php echo $ricedata['l_disaster_area'];?>" id="l_disaster_area">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_production"   value="<?php echo $ricedata['l_production'];?>" id="l_production">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			     <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_market_price"   value="<?php echo $ricedata['l_market_price'];?>" id="l_market_price">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	...
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_purchase_price"    value="<?php echo $ricedata['l_purchase_price'];?>" id="l_purchase_price">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			      	<label for="l_fertilizer_price" class="col-sm-3 control-label"><span class="need">*</span>晚稻肥料价格(元/公斤)：</label>
			      	<div class="col-sm-3">
			         	<input type="text" class="form-control" name="l_fertilizer_price"   value="<?php echo $ricedata['l_fertilizer_price'];?>" id="l_fertilizer_price">
			      	</div>
			      	<div><div class="Validform_checktip"></div></div>
			    </div>
			    <div class="form-group">
			    ...
			    <input type="hidden"  name="rice_kind"  value=3>
			  	<input type="hidden" name="rice_id" value="<?php echo $ricedata['rice_id']; ?>">
			    <div class="form-group">
			      	<div class="col-sm-offset-3 col-sm-10">
			        	<input type="submit" class="btn btn-info" value="确认修改">
