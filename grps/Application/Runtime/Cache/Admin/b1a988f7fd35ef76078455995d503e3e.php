                        	...
                        	<a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        		...
                        		<ul class="dropdown-menu">
                           			<?php foreach ($disalist as $key => $value):?>
                           				<li><a href="/grps/index.php/Admin/Guest/../Index/show?lati=<?php echo $value['dist_latitude']?>&long=<?php echo $value['dist_longitude']?>"><?php echo $value['dist_name'];?></a></li>
                           				<?php endforeach; ?>
                        		</ul>
                    	</li>
                    	<?php } ?>
		   ...
		   <tbody id="table">
		      	<?php foreach ($userdata as $key => $value): ?>
		   			<tr>
			         	...
			         	<td>
			         		<div id="b">
								<a href= "/grps/index.php/Admin/Guest/../Guest/deleteGuest?user_id=<?php  echo $value['user_id'];?>" class="btn btn-warning del" role="button">删除</a>
								<a href="/grps/index.php/Admin/Guest/../Guest/updateInfo?user_id=<?php  echo $value['user_id']; ?>" class="btn btn-primary" role="button">编辑</a>
							</div>

							<!--
							<div id="s" style="display:none">
								<p>是否要删除<?php echo $value['user_name']?>的相关信息？</p>
								<a href= "/grps/index.php/Admin/Guest/../User/deleteUser?user_id=<?php  echo $value['user_id'];?>" class="btn btn-warning">删除</a>
